...
class WindowType(str, Enum):
    ...
    COMBO="_NET_WM_WINDOW_COMBO"
    DESKTOP="_NET_WM_WINDOW_DESKTOP"
    DIALOG="_NET_WM_WINDOW_DIALOG"
    DND="_NET_WM_WINDOW_DND"
    DOCK="_NET_WM_WINDOW_DOCK"
    DROPDOWN_MENU="_NET_WM_WINDOW_DROPDOWN_MENU"
    MENU="_NET_WM_WINDOW_MENU"
    NORMAL="_NET_WM_WINDOW_NORMAL"
    NOTIFICATION="_NET_WM_WINDOW_NOTIFICATION"
    POPUP_MENU="_NET_WM_WINDOW_POPUP_MENU"
    SPLASH="_NET_WM_WINDOW_SPLASH"
    TOOLBAR="_NET_WM_WINDOW_TOOLBAR"
    UTILITY="_NET_WM_WINDOW_UTILITY"
